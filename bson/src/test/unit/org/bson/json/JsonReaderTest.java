...
public class JsonReaderTest {
    ...
    public void testDecimal128StringConstructor() {
        ...
        assertEquals(Decimal128.valueOf("314E-2"), bsonReader.readDecimal128());
        assertEquals(AbstractBsonReader.State.DONE, bsonReader.getState());
    }
    ...
    public void testDecimal128Int32Constructor() {
        ...
        bsonReader = new JsonReader(json);
        assertEquals(BsonType.DECIMAL128, bsonReader.readBsonType());
        assertEquals(Decimal128.valueOf(Integer.MAX_VALUE), bsonReader.readDecimal128());
        assertEquals(AbstractBsonReader.State.DONE, bsonReader.getState());
    }
    ...
    public void testDecimal128Int64Constructor() {
        ...
        bsonReader = new JsonReader(json);
        assertEquals(BsonType.DECIMAL128, bsonReader.readBsonType());
        assertEquals(Decimal128.valueOf(Long.MAX_VALUE), bsonReader.readDecimal128());
        assertEquals(AbstractBsonReader.State.DONE, bsonReader.getState());
    }
    ...
    public void testDecimal128DoubleConstructor() {
        ...
        bsonReader = new JsonReader(json);
        assertEquals(BsonType.DECIMAL128, bsonReader.readBsonType());
        assertEquals(Decimal128.valueOf("1"), bsonReader.readDecimal128());
        assertEquals(AbstractBsonReader.State.DONE, bsonReader.getState());
    }
