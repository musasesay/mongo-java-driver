...
class BsonNumberSpecification extends Specification {
    ...
    def 'should convert to int value'() {
        ...
        new BsonDecimal128(Decimal128.valueOf(1L)).intValue() == 1
    }
    ...
    def 'should convert to long value'() {
        ...
        new BsonDecimal128(Decimal128.valueOf(1L)).longValue() == 1L
    }
    ...
    def 'should convert to double value'() {
        ...
        new BsonDecimal128(Decimal128.valueOf('3.14')).doubleValue() == 3.14d
    }

    def 'should convert to decimal128 value'() {
        expect:
        new BsonInt32(1).decimal128Value() == Decimal128.valueOf('1')

        new BsonInt64(1L).decimal128Value() == Decimal128.valueOf('1')
        new BsonInt64(Long.MAX_VALUE).decimal128Value() == Decimal128.valueOf('9223372036854775807')
        new BsonInt64(Long.MIN_VALUE).decimal128Value() == Decimal128.valueOf('-9223372036854775808')

        new BsonDouble(1.0d).decimal128Value() == Decimal128.valueOf('1')
        ...
        new BsonDecimal128(Decimal128.valueOf('3.14')).decimal128Value() == Decimal128.valueOf('3.14')
    }
